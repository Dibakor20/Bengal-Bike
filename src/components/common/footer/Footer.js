      ...
      <div className="footer-section">
        <div className="main-footer">
          <div className="container">
            <div className="row">
              <div className="col-md-3 ps-4 ps-md-0 col-6">
                ...
                <div className="footer-text ">
                  ...
                  <p>
                    507-Union Trade ipsum Doler CentreZero Road, Bangladesh.
                  </p>
                </div>
              </div>
              ...
              <div className="col-md-3 col-6">
                <div className="footer-text">
                  ...
                  <ul>
                    ...
                    <li>
                      <Link to="/">Leal Notice</Link>
                    </li>
                    <li>
                      <Link to="/">Terms and condition of use</Link>
                    </li>
                    <li>
              ...
              <div className="col-md-3 col-6">
                ...
                <div>
                  <div className="footer-text">
                    ...
                    <img
                      src="https://i.ibb.co/r4skg0Z/american-express.png"
                      alt=""
                    />
                    <img
                      src="https://i.ibb.co/jggDYdg/carte-bleue.png"
                      alt=""
                    />
                    <img
                      src="https://i.ibb.co/pLRKKmW/master-card.png"
                      alt=""
                    />
                  ...
                  <div className="footer-text my-4">
                    <h5 className="py-2">Downloads Apps</h5>
                    <img
                      src="https://i.ibb.co/2jYMQMF/apple-store.png"
                      alt=""
                      className="py-2"
                    />
                    <img
                      src="https://i.ibb.co/px2Y8sx/google-store.png"
                      alt=""
                    />
                  </div>
                </div>
